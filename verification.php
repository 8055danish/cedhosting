...
if (isset($_POST['submite'])) {
	if($result[0]['email_approved']==0){
	$email = $result[0]['email'];
	$msg = $ob->emailverification($email, $result[0]['name'], $result[0]['id']);
	$msg = "Email send to your Gmail Account";
	$classname = "danger";
	}
}
		...
		<div class="container">
			...
			<div class="container row " style="margin-top:40px;margin-bottom:40px;">
				<div class="col-md-6 login-right">
					...
					<?php $result0 = $ob->getData('tbl_user', '', ['id' => $_SESSION['user_id']]);?>
					<form action="verification.php" method="POST">
						<div>
							<span>Email Address<label>*</label></span>
							<input type="text" placeholder="Enter Email" id="email" name="email" value="<?php echo $result0[0]['email']; ?>" disabled>
						</div>
						<div>
							<?php if ($result0[0]['email_approved'] == '0'): ?>
					...
					<div class="col-md-6 login-right">
						...
						<form action="verification.php" method="POST">
							<div>
								...
								<input type="text" placeholder="Enter phone Number" id="mobile" name="mobile" value="<?php echo $result0[0]['mobile']; ?>" disabled>
							</div>
							<div>
								<?php if ($result0[0]['phone_approved'] == '0'): ?>
